package com.ugb.shestarrestaurant.fragments;
...
import com.ugb.shestarrestaurant.adapters.FeaturedAdapter;
import com.ugb.shestarrestaurant.adapters.FeaturedVerAdapter;
import com.ugb.shestarrestaurant.models.FeaturedModel;
import com.ugb.shestarrestaurant.models.FeaturedVerModel;
...
///////////////////////Featured Ver RecyclerView
        ...
        featuredVerModelsList.add(new FeaturedVerModel(R.drawable.ver1, "Featured 1", "Description 1", "4.8", "10:00 - 23:00"));
        featuredVerModelsList.add(new FeaturedVerModel(R.drawable.ver2, "Featured 2", "Description 2", "4.8", "10:00 - 23:00"));
        featuredVerModelsList.add(new FeaturedVerModel(R.drawable.ver3, "Featured 3", "Description 3", "4.8", "10:00 - 23:00"));
        featuredVerModelsList.add(new FeaturedVerModel(R.drawable.ver1, "Featured 1", "Description 1", "4.8", "10:00 - 23:00"));
        featuredVerModelsList.add(new FeaturedVerModel(R.drawable.ver2, "Featured 2", "Description 2", "4.8", "10:00 - 23:00"));
        featuredVerModelsList.add(new FeaturedVerModel(R.drawable.ver3, "Featured 3", "Description 3", "4.8", "10:00 - 23:00"));
